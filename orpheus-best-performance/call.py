...
BASETEN_API_KEY = "hyUQgCX6.l1DkdmprvdXOGHTuPFGXachilSKEyuqi"
...
# Sample prompts
prompts = [
    """I'm calling regarding your Chase account ending in eight six one three that is currently past-due with an amount due of 86 dollars."""
]
